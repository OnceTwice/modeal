...
<head>
	...
	<link href="${pageContext.request.contextPath}/assets/css/bootstrap/metisMenu.min.css" rel="stylesheet">
	<link href="${pageContext.request.contextPath}/assets/css/bootstrap/sb-admin-2.css" rel="stylesheet">
	<link href="${pageContext.request.contextPath}/assets/css/bootstrap/morris.css" rel="stylesheet">
	<link href="${pageContext.request.contextPath}/assets/css/bootstrap/font-awesome.min.css" rel="stylesheet" type="text/css">
</head>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation"
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="${pageContext.request.contextPath }">관리자 페이지</a>
			</div>
			<!-- /.navbar-header -->
			...
			<div class="navbar-default sidebar" role="navigation">
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<li><a href="index.html"><i class="fa fa-dashboard fa-fw"></i>공지사항</a></li>
						<li><a href="#"><i class="fa fa-bar-chart-o fa-fw"></i>사용자 리스트<span class="fa arrow"></span></a>
						...
						<li><a href="#"><i class="fa fa-wrench fa-fw"></i>통계<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
